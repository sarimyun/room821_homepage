    ...
    return (
        <div style={{ width: width, height: '100%', background: '#f5f5f5', position: 'relative' }}>
            <div className="Frame48" style={{ width: width, height: 907, position: 'relative', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex' }}>
                ...
                <img className="JasonGoodmanBzqu01vG54Unsplash1" src={blog_image1} alt='blog_image1' style={{ left: (13 / 120) * width, top: 210, position: 'absolute', width: (1128 / 1440) * width, height: 'auto', borderRadius: 48 }} />
            </div>
